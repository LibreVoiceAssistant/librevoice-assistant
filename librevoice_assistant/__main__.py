...
from librevoice_assistant.listener.service import SpeechService
from librevoice_assistant.skills.skill_manager import MyAssistantSkillManager


def on_ready():
    LOG.info('My Assistant service started!')


def on_error(e='Unknown'):
    LOG.info('My Assistant failed to start ({})'.format(repr(e)))


def on_stopping():
    LOG.info('My Assistant is shutting down...')
